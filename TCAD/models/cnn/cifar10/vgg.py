...
'''VGG in PyTorch for Cifar10.

Code and pretrained weights from: https://github.com/huyvnphan/PyTorch_CIFAR10
'''
import os
...
def _vgg(arch, cfg, batch_norm, pretrained, progress, device, **kwargs):
    ...
    if pretrained:
        state_dict = torch.load("weights/cifar10_" + arch + "/" + arch + ".pt", map_location=device)
