...
'''Efficient in PyTorch for Cifar10.

Code and pretrained weights from: https://github.com/hankyul2/EfficientNetV2-pytorch
'''
import os
import copy
...
def get_efficientnet_v2(model_name, pretrained, nclass=0, dropout=0.1, stochastic_depth=0.2, **kwargs):
    ...
    if pretrained:
        state_dict = torch.load("weights/efficientnet_v2_s_cifar10/efficientnet_v2_s_cifar10.pth", map_location="cpu")
