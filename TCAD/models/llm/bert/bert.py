'''Modified from Transformer version v5.0.0.
'''
import torch
...
class BertSelfAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        attn_weights = self.matmul1(query_layer, key_layer.transpose(2, 3)) * self.scaling
        ...
        attn_output = self.matmul2(attn_weights, value_layer)
